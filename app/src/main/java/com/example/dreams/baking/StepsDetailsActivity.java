...
public class StepsDetailsActivity extends AppCompatActivity {
    ...
    @BindBool(R.bool.two_pane_mode) boolean isTwoPane;

    @BindView(R.id.recipe_step_tablayout) TabLayout tabLayout;
    @BindView(R.id.recipe_step_viewpager) ViewPager viewPager;
